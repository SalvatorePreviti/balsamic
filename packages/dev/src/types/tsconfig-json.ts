export interface TsconfigJson {
  ...
  buildOptions?: TsconfigJson.BuildOptions

  'ts-node'?: TsconfigJson.TsNodeOptions
...
export namespace TsconfigJson {
  export interface CompilerOptions {
    ...
    jsx?: 'preserve' | 'react' | 'react-jsx' | 'react-jsxdev' | 'react-native' | string
  ...
  export interface TsNodeOptions {
    ...
    transpiler?: [string, { [k: string]: unknown }, ...(string | { [k: string]: unknown })[]] | string
