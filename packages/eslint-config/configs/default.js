...
const config = {
  ...
  rules: {
    ...
    'no-unreachable': 1,
    'no-unused-expressions': [1, { allowShortCircuit: false, allowTaggedTemplates: false, allowTernary: false }],
    ...
    'padding-line-between-statements': [0, ...sharedRules.paddingLineBetweenStatementsRules],
    ...
    'quick-prettier/prettier': [
      1,
      {
        ...
        rules: {
          'padding-line-between-statements': [1, ...sharedRules.paddingLineBetweenStatementsRules],
